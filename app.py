    ...
    def build_quote_html(self, tech: RoleTotals, eng: RoleTotals, exp_lines: List[ExpenseLine], meta: TDict[str, object]) -> str:
        ...
        if LOGO_PATH.exists():
            try:
                ...
                logo_html = f'<img src="data:image/png;base64,{b64}" alt="Pearson" height="18" style="height:18px; width:auto; display:inline-block;" />'
            except Exception:
                logo_html = ""
        ...
        <style>
            ...
            .quote-logo {{ height: 18px; width: auto; display: inline-block; margin: 0; }}
