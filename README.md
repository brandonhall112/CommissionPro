...
7. Review machine breakdown, labor, expenses, and total.
8. Click **Print Quote…** to print or save as PDF.
...
- The same machine model cannot be selected twice; increase quantity on the existing line.
